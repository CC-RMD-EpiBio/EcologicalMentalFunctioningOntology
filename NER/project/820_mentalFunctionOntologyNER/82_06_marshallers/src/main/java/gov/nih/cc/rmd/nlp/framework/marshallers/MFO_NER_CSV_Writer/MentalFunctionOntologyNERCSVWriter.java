//=================================================
/**
 * MentalFunctionOntologyNERAnnotator creates MentalFunction ontology derived annotations in text
 * 
 * @author  GD
 * @created 2022.03.28
 * 
...
public class MentalFunctionOntologyNERCSVWriter extends AbstractWriter {
  ...
  **/
  // =================================================
  public MentalFunctionOntologyNERCSVWriter(String[] pArgs) throws ResourceInitializationException {
    initialize( pArgs);
  } // end Constructor() ----------------------
   ...
   private List<String> getInstanceRows(JCas pJCas, String pFileName) {
     ...
     if ( instances != null && !instances.isEmpty())
       for ( Annotation instance : instances ) {
         ...
         String contextLeft = UIMAUtil.getLeftContext(pJCas, instance, 80);
         if ( contextLeft == null ) contextLeft = " ";
         String contextRight = UIMAUtil.getRightContext(pJCas, instance, 80);
         if ( contextRight == null ) contextRight = " ";
         ...
         buff.append( U.spacePadLeft(80,  contextLeft));  buff.append( COLUMN_DELIMITER );
         buff.append( U.spacePadLeft(50,  mention));      buff.append( COLUMN_DELIMITER );
         buff.append( U.spacePadLeft(80,  contextRight)); buff.append( COLUMN_DELIMITER );

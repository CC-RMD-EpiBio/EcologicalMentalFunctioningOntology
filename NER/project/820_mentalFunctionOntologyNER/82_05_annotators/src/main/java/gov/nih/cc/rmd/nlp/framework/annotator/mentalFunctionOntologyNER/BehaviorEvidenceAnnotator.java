// =================================================
/**
 * BehaviorEvidenceAnnotator marks behavior Evidence from sentences
 *   
 * 
 * @author  GD
 * @created 2023.02.15
...
public class BehaviorEvidenceAnnotator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas pJCas) throws AnalysisEngineProcessException {
    ...
    GLog.println(GLog.DEBUG_LEVEL, this.getClass(), "process","started BehaviorEvidenceAnnotator");
    ...
    GLog.println(GLog.DEBUG_LEVEL, this.getClass(), "process","End BehaviorEvidenceAnnotator");
...
// =================================================
  /**
   * processSentence finds behavior evidence in this sentence
   * 
   * @param pJCas
   * @param pSentence
  */
  ...
  private void processSentence(JCas pJCas, Annotation pSentence) {
      ...
      if ( terms != null && !terms.isEmpty()) {
        for ( Annotation term: terms ) {
          ...
          if ( semanticTypes.contains("BehaviorEvidence") || semanticTypes.contains("Behavior_") ) {
           
            createBehaviorEvidence( pJCas, term);
          }
        ...
        // =================================================
        /**
         * createBehaviorEvidence [TBD] summary
         * 
         * @param pJCas
         * @param term
        */
        // =================================================
           private final void createBehaviorEvidence(JCas pJCas, Annotation pMention) {
          Annotation statement = new BehaviorEvidence(pJCas);

// =================================================
/**
 * MakeIPIRCopper creates Copper annotations for x.IPIR_yes
 * sentences
 *   
 * 
 * @author  GD
...
public class MakeIPIRCopperAnnotator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas pJCas) throws AnalysisEngineProcessException {
    ...
    List<Annotation> focusAnnotations = UIMAUtil.getAnnotations(pJCas,gov.nih.cc.rmd.inFACT.x.IPIR_yes.typeIndexID , false);
  ...
  */
  ...
  private String getEvidencesAll(JCas pJCas, Annotation pStatement  ) {
	  ...
	  try {
		  ...
		  List<Annotation> activities = UIMAUtil.fuzzyFindAnnotationsBySpan(pJCas, IPIRActivities.typeIndexID, pStatement.getBegin(), pStatement.getEnd(), true );
		  if ( terms != null && !terms.isEmpty() )
...
public void destroy() {
  ...
  public void initialize(String[] pArgs) throws ResourceInitializationException {
    ...
    this.evalCopperFocus  =  U.getOption(pArgs, "--evalCopperFocus=" ,"IPIRActivities" );

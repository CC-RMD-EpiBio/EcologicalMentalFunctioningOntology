// =================================================
/**
 * supportEvidenceAnnotator marks support Evidence from sentences
 *   
 * 
 * @author  GD
 * @created 2023.02.15
...
public class SupportEvidenceAnnotator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas pJCas) throws AnalysisEngineProcessException {
    ...
    GLog.println(GLog.DEBUG_LEVEL, this.getClass(), "process"," Started SupportEvidenceAnnotator");
    ...
    GLog.println(GLog.DEBUG_LEVEL, this.getClass(), "process"," End SupportEvidenceAnnotator");
...
// =================================================
  /**
   * processSentence finds support evidence in this sentence
   * 
   * @param pJCas
   * @param pSentence
  */
  ...
  private void processSentence(JCas pJCas, Annotation pSentence) {
      ...
      if ( terms != null && !terms.isEmpty()) {
        for ( Annotation term: terms ) {
          ...
          if ( semanticTypes.contains("SupportQualifier") ||
              semanticTypes.contains("SupportFutureEvidence") ||
              semanticTypes.contains("SupportEvidence"))
          
            
            createSupportEvidence( pJCas, term);
        ...
        */
        // =================================================
           private final void createSupportEvidence(JCas pJCas, Annotation pMention) {
          Annotation statement = new SupportEvidence(pJCas);
          statement.setBegin( pMention.getBegin());
          statement.setEnd( pMention.getEnd());
          statement.addToIndexes();

          
        }  // end Method createsupportEvidence() ------------

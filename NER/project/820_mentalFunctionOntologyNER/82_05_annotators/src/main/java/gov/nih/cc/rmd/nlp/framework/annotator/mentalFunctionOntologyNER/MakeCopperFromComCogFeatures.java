// =================================================
/**
 * MakeCopperFromComCogFeatures creates Copper annotations for 
 * the features for the ComCog_yes features under consideration for evaluation
...
public class MakeCopperFromComCogFeatures extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas pJCas) throws AnalysisEngineProcessException {
   ...
   // ------------------------------
    Class<?> evalClass = UIMAUtil.mapLabelToUIMAClass(this.evalCopperFocus);
    
    List<Annotation> focusAnnotations = UIMAUtil.getAnnotations(pJCas, evalClass, false);
    ...
    if (focusAnnotations != null && !focusAnnotations.isEmpty() )
      for ( Annotation focusAnnotation : focusAnnotations ) {
    	 ...
    	 String evidences = getEvidences( pJCas, focusAnnotation, this.evalCopperFocus);
...
//=================================================
  ...
  */
  ...
  private String getEvidences(JCas pJCas, Annotation pStatement, String pEvalFocus ) {
	  ...
	  String evalFocuz = ComCogCategories.translateComCogClassToLRAGRSemanticType( pEvalFocus);
	  String [] evalFocuses = null;
	  if ( evalFocuz != null && evalFocuz.trim().length() > 0 ) {
		  evalFocuses = U.split( evalFocuz, ":");
	  }
...
public void destroy() {
  ...
  public void initialize(String[] pArgs) throws ResourceInitializationException {
    ...
    this.evalCopperFocus  =  U.getOption(pArgs, "--evalCopperFocus=" ,"D330_D349_comProducing" );

...
import gov.nih.cc.rmd.nlp.framework.annotator.mentalFunctionOntologyNER.MakeXFromMachineFeatures;
 ...
 */
  ...
  public class InFACTSubCategorizationBySentenceComcogMachinePipeline extends AbstractPipeline  {
     ...
     */
    // =======================================================
    public InFACTSubCategorizationBySentenceComcogMachinePipeline(String[] pArgs) {
      super(pArgs);
     ...
     */
    // -----------------------------------------
    public InFACTSubCategorizationBySentenceComcogMachinePipeline()  throws Exception {
     super( );
  ...
  public FrameworkPipeline createPipeline(String[] pArgs) {
      ...
      pipeline.add(              MakeXFromMachineFeatures.class.getCanonicalName(), argsParameter);

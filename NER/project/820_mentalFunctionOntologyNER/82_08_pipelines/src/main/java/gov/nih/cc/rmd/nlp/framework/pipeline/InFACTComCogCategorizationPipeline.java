 ...
 */
  ...
  public class InFACTComCogCategorizationPipeline extends AbstractPipeline  {
     ...
     */
    // =======================================================
    public InFACTComCogCategorizationPipeline(String[] pArgs) {
      super(pArgs);
     ...
     */
    // -----------------------------------------
    public InFACTComCogCategorizationPipeline()  throws Exception {
     super( );
  ...
  public FrameworkPipeline createPipeline(String[] pArgs) {
   ...
   //   pipeline.add(              POSAnnotator.class.getCanonicalName(), argsParameter);
      ...
      pipeline.add(              InFACT_ComCogCategoriesPostProcessing.class.getCanonicalName(), argsParameter ); //<--- for inFACT GATE files

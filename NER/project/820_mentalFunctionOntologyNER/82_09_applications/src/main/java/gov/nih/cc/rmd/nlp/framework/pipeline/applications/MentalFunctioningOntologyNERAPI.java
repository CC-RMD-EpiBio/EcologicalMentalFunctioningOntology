// ------------------------------------------------------------
/**
 * An api annotating MentalFunctionOntologyNER elements in documents
 ...
 */
// ------------------------------------
public class MentalFunctioningOntologyNERAPI extends ApplicationAPI {
...
//=======================================================
  ...
  */
  // ====================================================
 public MentalFunctioningOntologyNERAPI() throws Exception {
  ...
  */
 // =====================================================
     public MentalFunctioningOntologyNERAPI( String[] pArgs) throws Exception {
  ...
  public void init(String[] pArgs) throws Exception {
    ...
    try {
      ...
      String args[]  = MentalFunctioningOntologyNERApplication.setArgs(pArgs );
      ...
      // -------------------
      MentalFunctioningOntologyNERPipeline MentalFunctioningOntologyNERPipeline = new MentalFunctioningOntologyNERPipeline(args );
    
      AnalysisEngine ae = MentalFunctioningOntologyNERPipeline.getAnalysisEngine( );
  ...
  public static void main(String[] pArgs) {
    ...
    try {
      ...
      String[] args = MentalFunctioningOntologyNERApplication.setArgs( pArgs);
      MentalFunctioningOntologyNERAPI anApplication = new MentalFunctioningOntologyNERAPI( args);
